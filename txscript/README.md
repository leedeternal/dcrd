...
[![Doc](https://img.shields.io/badge/doc-reference-blue.svg)](https://pkg.go.dev/github.com/leedeternal/dcrd/txscript/v4)
...
This package is part of the `github.com/leedeternal/dcrd/txscript/v3` module.  Use
the standard go tooling for working with modules to incorporate it.

## Examples

* [Counting Opcodes in Scripts](https://pkg.go.dev/github.com/leedeternal/dcrd/txscript/v4#example-ScriptTokenizer)
