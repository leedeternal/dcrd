module github.com/leedeternal/dcrd/rpcclient/v8

go 1.17

require (
	github.com/leedeternal/dcrd/chaincfg/chainhash v1.0.4
	github.com/leedeternal/dcrd/dcrjson/v4 v4.0.1
...
require (
	...
	github.com/leedeternal/dcrd/blockchain/stake/v5 v5.0.1 // indirect
	github.com/leedeternal/dcrd/chaincfg/v3 v3.2.1 // indirect
