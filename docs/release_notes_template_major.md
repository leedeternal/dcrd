...
* {TODO: [DCP####: DCP Title](https://github.com/leedeternal/dcps/blob/master/dcp-####/dcp-####.mediawiki)}
* {TODO: [DCP####: DCP Title](https://github.com/leedeternal/dcps/blob/master/dcp-####/dcp-####.mediawiki)}
...
- [{TODO: RPC method} JSON-RPC API Documentation](https://github.com/leedeternal/dcrd/blob/master/docs/json_rpc_api.mediawiki#{TODO: RPC method})
...
[here](https://github.com/leedeternal/dcrd/compare/release-v{TODO: X.Y.Z}...release-v{TODO: X.Y}.0).
